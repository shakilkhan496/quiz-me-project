    ...
    return (
        <div className='flex items-center justify-center mt-20'>
            ...
            <div class="w-5/6 flex flex-col items-center bg-white rounded-lg border shadow md:flex-row  hover:bg-blue-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <img class="object-cover lg:w-1/2 md:w-1/2  rounded-t-lg   md:rounded-none md:rounded-l-lg" src="https://media.istockphoto.com/photos/quiz-time-concept-speech-bubble-with-pencil-on-yellow-background-picture-id1268465415?k=20&m=1268465415&s=612x612&w=0&h=dzRhC8EPw1bZTIDzxc0416FaL8IF71RCPNjBlYUgzQA=" alt="" />
